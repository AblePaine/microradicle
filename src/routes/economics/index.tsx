  ...
  head: () => ({
    meta: [
      { title: "Pack-shed — MicroRadicle" },
      {
        name: "description",
        content:
          "This week's harvest in the pack-shed. Field heat, CoolBot sizing, and what not to put in the 34°F box.",
      },
    ],
  }),
});
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
      <header className="mb-6">
        <p className="font-mono text-[11px] tracking-[0.22em] text-accent uppercase">Module 04 · pack-shed</p>
        <h1 className="font-display mt-1 text-4xl font-semibold tracking-wide sm:text-5xl">COLD CHAIN</h1>
        <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted">
          Harvest from this week's beds walks in hot. We add up field heat plus the crop still breathing,
          then ask whether the CoolBot can knock it down in four hours. Hydrocooling is the first pass —
          the window unit is not a miracle. Keep tomatoes, peppers, cukes, and basil out of the 34°F box.
        </p>
      </header>
