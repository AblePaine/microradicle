  ...
  head: () => ({
    meta: [
      { title: "Drip — MicroRadicle" },
      {
        name: "description",
        content:
          "Drip sizer for 30-inch beds. How much water each crop wants, and whether the header and mainline can keep up.",
      },
    ],
  }),
});
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
      <header className="mb-6">
        <p className="font-mono text-[11px] tracking-[0.22em] text-accent uppercase">Module 02 · drip</p>
        <h1 className="font-display mt-1 text-4xl font-semibold tracking-wide sm:text-5xl">DRIP ZONES</h1>
        <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted">
          Each cultivar already knows how much water it wants. We size the header and the poly mainline
          so pressure holds at the far end. Keep flow under 5 feet a second and tape above 8 psi. One
          zone at a time is the usual program; everything at once is the stress test.
        </p>
      </header>
